% It was requested by [11cd4d] that I follow ProQuest[39dc03] requirements for the
% abstract, but I have no idea where to find those with the exception of [338de7]
% limiting the abstract to 775 words.
In this work, we take a look at representation learning.
% In [66d095], Donald Williamson recommended that I should justify the reason for representation
