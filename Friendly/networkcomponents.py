...
# See [170ecf] for this module's reference
import chainer

# The math[7c779f] module
import math
...
# Idea defined by [cfb615, section 3.2.2]
    ...
    def __init__(self):
        ...
        self.code =  'extern "C" {                                                                       \
                         ...
                         __device__ __forceinline__ calculatePosition(long long sample,                  \
                             ...
                             // from stride) or I\'ve written it sometime before[71bd98]            \
                         ...
                         __global__ void (float* cuts,                                                   \
                            ...
                            // See [cfb615, section 3.2.3] to understand why the code does what it         \
                            // does                                                                      \
...
# A description of this layer can be found in [cfb615, section 3.2.3]
class PairwiseDifference(chainer.Link):

    # Accepts the parameters of chainer.functions.im2col(...)[964016], but in keyword
...
# Implementation of [cfb615, section 3.2.4]
class Angular(chainer.Link):
    ...
    def forward(self, tensor):
        ...
        # multiplication because I think, according to [ef4545], it broadcasts the matrix
